...
const search=()=>{
  ...
  description:'Titanic est un film dramatique américain écrit, produit et réalisé par James Cameron, sorti en 1997.',
   ...
   rating:'4 start',
   trailer:"https://youtu.be/cIJ8ma0kKtY"
  },{
...
, trailer:"https://youtu.be/7bfS6seiLhk"
},
  {
    ...
    rating:"9.9 start",
    trailer:"https://youtu.be/quHQAuO0lkg"
  }
  ]);
  return (
    <div>
...
<div className="inp-border a3">
<input  className="input" ref={a} type='text' placeholder="Url trailer-link"></input>  
</div>
...
<Filter g={g} l={l} search={search}/>
  ...
  <Route path='/movie/:titi' element={<Movie movies={movies}/>}/>
  </Routes>
  </div>
  )
}
